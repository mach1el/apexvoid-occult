...
### Sửa Lỗi (Fixed)
- **Tử Vi**: Sửa hồi quy scale — lá số và workspace desktop không còn phình theo full màn QHD/ultrawide; khôi phục trần cột 1040px và giới hạn chiều cao SVG theo viewport.
