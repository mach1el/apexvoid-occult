...
- **Tử Vi**: Desktop — lá số gọn fit view (trần ~1200px, sized theo chiều cao viewport), rộng/cao hơn một chút so với bản 1120; chatbox cùng hàng kéo dài theo; SVG giữ `width`/`height` attribute để không collapse mất lưới 12 cung.
